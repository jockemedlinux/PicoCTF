...
#Listjoiner.py : @jockemedlinux 2022-08-09 : EASYLISTWORKER#
import argparse
parser = argparse.ArgumentParser('Listjoiner.py')
parser.add_argument("inputfile1", help="Insert list1 (usually usernames.txt)")
parser.add_argument("inputfile2", help="Insert list2 (usually passwords.txt)")
